...
- Header cell. Content is children, not label.
...
| `alignment` | `TableAlignment \| undefined` | no | `'left'` |  |
| `scope` | `"row" \| "col" \| undefined` | no | `'col'` | Header association; defaults to col. Use row for a row header. |
